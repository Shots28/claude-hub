      ...
      <nav className="md:hidden flex-shrink-0 border-t border-hub-border bg-hub-bg pb-safe">
        <div className="flex items-center justify-center gap-2 h-10 px-4">
          ...
          >
            ...
            {totalAttention > 0 && (
              <span className="min-w-[18px] h-4 flex items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white px-1">
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 rounded-full bg-hub-accent hover:bg-hub-accent-hover active:scale-95 transition-all shadow-md"
          >
          ...
          <Link
            href="/settings"
            className={`flex items-center gap-1.5 h-9 px-3 rounded-full transition-all active:scale-95 ${
              activeTab === "settings"
                ? "bg-hub-accent text-white"
                : "bg-hub-surface-2 text-hub-text-muted active:bg-hub-border"
            }`}
