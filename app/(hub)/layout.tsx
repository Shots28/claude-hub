...
function HubLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-dvh flex flex-col md:flex-row overflow-hidden bg-hub-bg pt-safe">
      ...
      {/* Mobile bottom nav - Compact centered design */}
      <nav className="md:hidden flex-shrink-0 border-t border-hub-border bg-hub-bg safe-area-bottom">
        <div className="flex items-center justify-center gap-2 h-16 px-4">
          ...
          <button
            ...
            className={`relative flex items-center gap-2 h-11 px-4 rounded-full transition-all active:scale-95 ${
              mobileListOpen
          ...
          >
            ...
            {totalAttention > 0 && (
              <span className="min-w-[20px] h-5 flex items-center justify-center rounded-full bg-red-500 text-[11px] font-bold text-white px-1.5">
          ...
          <button
            ...
            className="flex items-center justify-center w-11 h-11 rounded-full bg-hub-accent hover:bg-hub-accent-hover active:scale-95 transition-all shadow-md"
          >
          ...
          <Link
            href="/settings"
            className={`flex items-center gap-2 h-11 px-4 rounded-full transition-all active:scale-95 ${
              activeTab === "settings"
                ? "bg-hub-accent text-white"
                : "bg-hub-surface-2 text-hub-text-muted active:bg-hub-border"
            }`}
