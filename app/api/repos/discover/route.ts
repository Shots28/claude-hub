...
// The local bridge scans the filesystem on startup and syncs results to DB.
// This route just reads from DB so it works on Vercel.
// NOTE: POST was removed - it ran on Vercel and cleared bridge's data!
// ---------------------------------------------------------------------------
